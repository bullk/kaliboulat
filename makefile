...
GUI_OBJS = GUI.o
MAIN_OBJS = Engine.o Clock.o Clip.o Scheduled.o Track.o midi.o MidiClip.o MidiTrack.o MidiFile.o AudioClip.o AudioTrack.o Project.o Modules.o State.o Listener.o Kaliboulat.o
